    ...
    <div className="fixed inset-0 bg-slate-50 dark:bg-midnight z-50 overflow-y-auto overflow-x-hidden selection:bg-accent selection:text-midnight scroll-smooth">
      ...
      <section className="min-h-[100dvh] flex flex-col items-center justify-center relative px-6 py-12 text-center z-10">
        ...
        >
          ...
          <motion.h1
            variants={fadeIn}
            className="text-4xl sm:text-5xl md:text-7xl lg:text-9xl font-extrabold text-[rgb(var(--color-text-main))] tracking-tighter mb-6 md:mb-8 leading-[0.95] md:leading-[0.9]"
          >
            Domptez <br />
      ...
      <section className="py-20 md:py-32 px-6 bg-surface/30 relative z-10 border-y border-slate-200 dark:border-slate-800/50 backdrop-blur-sm overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <motion.blockquote
            ...
            className="text-2xl md:text-5xl font-serif italic text-slate-800 dark:text-slate-200 leading-tight mb-6 md:mb-8"
          >
      ...
      <section className="py-20 md:py-32 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-24">
            <h2 className="text-3xl md:text-4xl font-bold text-[rgb(var(--color-text-main))] mb-4">Le Protocole LUCID</h2>
            <p className="text-sm md:text-base text-slate-600 dark:text-slate-400">Comment déconstruire l'anxiété en 3 étapes.</p>
          </div>
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={fadeIn}
                className="bg-white/40 dark:bg-surface/40 border border-slate-200 dark:border-slate-800 p-6 md:p-8 rounded-3xl hover:bg-white/60 dark:hover:bg-surface/60 transition-colors group"
              >
                <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-slate-100 dark:bg-slate-900 flex items-center justify-center mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300 border border-slate-200 dark:border-slate-800">
                  <item.icon size={24} className="text-slate-600 dark:text-slate-300 group-hover:text-accent transition-colors md:w-8 md:h-8" />
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-[rgb(var(--color-text-main))] mb-2 md:mb-4">{item.title}</h3>
      ...
      <section className="py-20 md:py-32 px-6 relative z-10 border-t border-slate-200 dark:border-slate-800/30">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            {/* Card 2: Privacy */}
            <motion.div variants={fadeIn} className="bg-white dark:bg-surface border border-slate-200 dark:border-slate-800 p-6 md:p-10 rounded-3xl relative overflow-hidden group hover:border-emerald-500/50 dark:hover:border-emerald-900/50 transition-colors">
              <div className="relative z-10">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-emerald-100 dark:bg-emerald-900/20 rounded-xl flex items-center justify-center mb-4 md:mb-6">
                  <Shield className="text-emerald-600 dark:text-emerald-500 w-6 h-6 md:w-auto md:h-auto" />
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-[rgb(var(--color-text-main))] mb-2 md:mb-3">Local First</h3>
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-8 relative z-10">
                <div className="flex-1">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-yellow-100 dark:bg-yellow-900/20 rounded-xl flex items-center justify-center mb-4 md:mb-6">
                    <Zap className="text-yellow-600 dark:text-yellow-500 w-6 h-6 md:w-auto md:h-auto" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold text-[rgb(var(--color-text-main))] mb-2 md:mb-3">Instantané</h3>
                ...
                {/* Stats Section */}
                <div className="flex items-center justify-around md:justify-end gap-4 md:pr-8 pt-4 md:pt-0 border-t md:border-t-0 border-slate-200 dark:border-slate-800/50 md:border-none w-full md:w-auto">
                  <div className="text-center md:text-right">
                    <span className="block text-2xl md:text-4xl font-bold text-[rgb(var(--color-text-main))]">0.1s</span>
                    <span className="text-[10px] md:text-xs text-slate-500 uppercase tracking-wider">Latence</span>
                  </div>
                  <div className="h-8 w-px bg-slate-200 dark:bg-slate-800 md:h-12" />
                  <div className="text-center md:text-right">
                    <span className="block text-2xl md:text-4xl font-bold text-[rgb(var(--color-text-main))]">0%</span>
      ...
      <section className="py-20 md:py-32 px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="relative bg-white/90 dark:bg-surface/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-[2rem] p-6 md:p-12 text-center overflow-hidden">
              {/* Background Grid */}
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl flex items-center justify-center mb-6 shadow-2xl rotate-3 group-hover:rotate-0 transition-transform duration-500">
                  <Code2 size={32} className="text-slate-900 dark:text-white md:w-10 md:h-10" />
                </div>

                <h2 className="text-2xl md:text-4xl font-bold text-[rgb(var(--color-text-main))] mb-2">Conçu par zay168</h2>
                <p className="text-slate-600 dark:text-slate-400 mb-8 text-base md:text-lg">Développeur Créatif & Designer UI</p>

                <a
                  href="https://github.com/zay168"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-6 py-3 md:px-8 md:py-4 bg-slate-900 text-white dark:bg-white dark:text-midnight rounded-xl font-bold hover:scale-105 hover:shadow-[0_0_30px_rgba(167,139,250,0.3)] transition-all duration-300 text-sm md:text-base"
                >
